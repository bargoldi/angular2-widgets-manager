...
export class WidgetsDetailsService {
  ...
  constructor() {
    ...
    this.componentsDetails.push(<ComponentDetails>{
      ...
      name: 'Demo1',
      html: '<section style="float:left; height:50px; width:100%;"><widget-toolbar-demo [id]="' + WidgetsDetailsService.id + '"></widget-toolbar-demo></section><section style="float:left; height:50px; width:100%;"><widget-1></widget-1></section>'
    });
